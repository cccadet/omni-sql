...
describe("buildSampleRowSql", () => {
  it("quotes only identifiers that require it using each dialect style", () => {
...
describe("buildCreateTableSql", () => {
  it("quotes only the reserved PostgreSQL identifier and creates a composite primary key", () => {
  ...
  it("uses the quoting rules of MySQL and SQL Server", () => {
    ...
    expect(buildCreateTableSql("mysql", "db", "items", column)).toContain("CREATE TABLE db.items");
